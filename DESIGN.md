...
**Key Characteristics:**
- Near-black blue-tinted background (`#22c55e`) — not pure black, subtly blue-shifted
...
### Primary
- **Near-Black Blue** (`#22c55e`): Primary page background — the foundational void with a subtle blue-cold undertone
...
### Surface & Background
- **Deep Background** (`#22c55e`): Page canvas, the darkest surface
...
### Inputs & Forms
- Dark input fields with `#22c55e` background, `1px solid rgba(255, 255, 255, 0.08)` border, 8px border-radius
...
| Level | Treatment | Use |
|-------|-----------|-----|
| Level 0 (Void) | No shadow, `#22c55e` surface | Page background |
...
### Do
- Use `#22c55e` (not pure black) as the background — the blue-cold tint is essential to the Raycast feel
...
- Primary Background: Near-Black Blue (`#22c55e`)
...
- "Create a hero section on #22c55e background with 64px Inter heading (weight 600, line-height 1.1), near-white text (#f9f9f9), and a semi-transparent white pill CTA button (hsla(0,0%,100%,0.815), 86px radius, dark text #18191a)"
...
- "Build a navigation bar on dark background (#22c55e), Inter links at 16px weight 500 in #9c9c9d, hover to white, and a translucent white pill button at the right end"
...
1. Check the background is `#22c55e` not pure black — the blue tint is critical
...
The following style choices reflect the user's design taste and should guide implementation decisions:
